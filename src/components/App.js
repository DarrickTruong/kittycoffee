    ...
    return (
        ...
        <div>
            ...
            <Router>
                ...
                <ShoppingCart shop_cart_items={shop_cart_items} removeItem={removeItem} updateCart={update_shop_cart} shopTotal={shopTotal} total={shop_total} />

                <Switch>

                    <Route path="/shop">
                        <Shop open_shop={open_shop} products={products} add_shop_cart={add_shop_cart}/>
                    </Route>
                    <Route path="/receipt">
                        <Receipt />
                    </Route>
