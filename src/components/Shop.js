...
//     }, [shop_cart_items])
    ...
    return (
        <main className="container d-flex flex-column align-items-center fade-in">
            ...
            <button onClick={props.open_shop} className="btn btn-checkout"><img id="shopping-cart" className="mr-2" src={shop_cart} alt="shopping cart"/>View Cart</button>
            
            <ProductList products={props.products} add_shop_cart={props.add_shop_cart} />
